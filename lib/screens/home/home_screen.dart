        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: const [
                _QuickLink(icon: Icons.menu_book_outlined, label: 'Diary'),
                _QuickLink(icon: Icons.fitness_center_outlined, label: 'Exercise'),
                _QuickLink(icon: Icons.bar_chart_outlined, label: 'Statistik'),
